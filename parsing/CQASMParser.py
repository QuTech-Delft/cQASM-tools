###################
# This script is an experimental, incomplete Python-only parser for cQasm.
# It misses a lot of language constructs (notably: bundles).
# It uses a Python library called Ply (see https://www.dabeaz.com/ply/ for docs),
# which is a rewrite of Flex (lexer generator) and Bison (parser generator) completely in Python.
# This way to parse is therefore quite inefficient, but completely fine
# for prototyping and testing new things on smaller circuits.
###################
...
reserved_keywords = { # Those are defined but not used.
    'q' : 'Q',
    'if' : 'IF',
    'for' : 'FOR',
    'then' : 'THEN',
...
# lex.runmain(data="""version 1.0;qubits 10;xm45 q[0]""")
